from src import Location, Weather
...
app.layout = html.Div(
    [
        ...
        html.Div(
            [
                html.Label("Введите города на маршруте:"),
                html.Div(
                    [
                        dcc.Input(
        ...
        html.Div(
            [
                html.Label("На сколько дней показать прогноз?"),
                dcc.Dropdown(
                    id="forecast-days",
                    options=[
...
@app.callback(Output("city-input-container", "children"), Input("add-city", "n_clicks"), State("city-input-container", "children"))
        ...
        try:
            ...
            for city, data in weather_data.items():
                ...
                precipitation_prob_layout = go.Layout(
                    title=f"Вероятность осадков в городе '{city}'",
